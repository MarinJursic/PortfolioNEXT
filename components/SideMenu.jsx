        ...
        >
          ...
          <ul>
            ...
            <Link href="#about" passHref>
              <li className={styles.circle}>
                <img src="./images/aboutnew.svg" alt="about" />
              </li>
            </Link>
            <Link href="#skills" passHref>
              <li className={styles.circle}>
                <img src="./images/skillsnew.svg" alt="skills" />
              </li>
            </Link>
            <Link href="#projects" passHref>
              <li className={styles.circle}>
                <img src="./images/Skills.webp" alt="projects" />
              </li>
            </Link>
            <Link href="#contact" passHref>
              <li className={styles.circle}>
                <img src="./images/contactnew.svg" alt="contact" />
              </li>
            </Link>
          </ul>
        </motion.div>
